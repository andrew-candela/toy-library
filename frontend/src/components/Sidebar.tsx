...
function ToysIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <path
        d="M9 8V6.5C9 5.67 9.67 5 10.5 5h3C14.33 5 15 5.67 15 6.5V8"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
...
function UsersIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <path
        d="M6.5 18.5c1.2-2.6 3.1-4 5.5-4s4.3 1.4 5.5 4"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
...
function ProfileIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
        d="M12 4.8l1.1 1.5 1.9-.1.7 1.8 1.8.7-.1 1.9 1.5 1.1-1.5 1.1.1 1.9-1.8.7-.7 1.8-1.9-.1L12 19.2l-1.1-1.5-1.9.1-.7-1.8-1.8-.7.1-1.9-1.5-1.1 1.5-1.1-.1-1.9 1.8-.7.7-1.8 1.9.1L12 4.8z"
        stroke="currentColor"
        strokeWidth="1.5"
...
function LogoutIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
        d="M10 6H6.8C5.81 6 5 6.81 5 7.8v8.4C5 17.19 5.81 18 6.8 18H10"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
      <path
        d="M13 8.5l3.5 3.5L13 15.5"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function AdminIcon() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
        d="M12 4l6.5 2.4v5.2c0 4-2.7 7.3-6.5 8.4-3.8-1.1-6.5-4.4-6.5-8.4V6.4L12 4z"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinejoin="round"
      />
  ...
  return (
    ...
    >
      ...
      <NavItem
        ...
        label="Toys"
        compact={isCompact}
        active={location.pathname.startsWith('/toys')}
        style={linkStyle('/toys')}
        icon={ToysIcon}
      />
      <NavItem
        to="/users"
